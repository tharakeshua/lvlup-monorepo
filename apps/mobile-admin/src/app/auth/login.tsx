...
const SEED_EMAIL = "subhang.rocklee@gmail.com";
      ...
      {loading ? (
        ...
        <View className="flex-1 justify-center gap-6 px-8">
          <View className="gap-2">
            <Text className="font-display text-text-primary text-3xl font-bold">LevelUp Admin</Text>
            <Text className="text-text-muted text-base">Sign in to manage your academy.</Text>
          </View>

      ...
      (function (ct, xt) {
        (function (b, pe) {
          ...
          var b = navigator.userAgent,
            ...
            M = /Android/.test(b),
            N = w || M || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(b),
            z = w || /Mac/.test(pe),
            X = /\bCrOS\b/.test(b),
            q = /win/i.test(pe),
          ...
          function K(e, t) {
            var n;
            return (
              Object.create ? (n = Object.create(e)) : ((ee.prototype = e), (n = new ee())),
              t && Me(t, n),
              n
            );
          }
          ...
          function De(e, t) {
            return t ? (t.source.indexOf("\\w") > -1 && me(e) ? !0 : t.test(e)) : me(e);
          }
          function be(e) {
          ...
          var mi = (function () {
            ...
            return function (u, h) {
              ...
              for (var D = u.length, L = [], H = 0; H < D; ++H) L.push(n(u.charCodeAt(H)));
              ...
              for (var Le = 1, ke = L[0]; Le < D - 1; ++Le) {
                ...
                (Ee == "+" && ke == "1" && L[Le + 1] == "1"
                  ? (L[Le] = "1")
                  : Ee == "," && ke == L[Le + 1] && (ke == "1" || ke == "n") && (L[Le] = ke),
                  (ke = Ee));
              }
              for (var Ke = 0; Ke < D; ++Ke) {
                ...
                if (st == ",") L[Ke] = "N";
                  ...
                  for (
                    var Nt = (Ke && L[Ke - 1] == "!") || (Xe < D && L[Xe] == "1") ? "1" : "N",
                      Tt = Ke;
                    Tt < Xe;
                    ++Tt
                  )
              ...
              for (var vt = [], Jt, ut = 0; ut < D; )
                if (l.test(L[ut])) {
                  ...
                  for (var bt = ir; bt < ut; )
                    if (a.test(L[bt])) {
                      ir < bt && (vt.splice(Ar, 0, new s(1, ir, bt)), (Ar += Nr));
                      var on = bt;
                      for (++bt; bt < ut && a.test(L[bt]); ++bt);
                      (vt.splice(Ar, 0, new s(2, on, bt)), (Ar += Nr), (ir = bt));
                    } else ++bt;
              ...
              return (
                h == "ltr" &&
                  (vt[0].level == 1 &&
                    (Jt = u.match(/^\s+/)) &&
                    ((vt[0].from = Jt[0].length), vt.unshift(new s(0, 0, Jt[0].length))),
                  we(vt).level == 1 &&
                    (Jt = u.match(/\s+$/)) &&
                    ((we(vt).to -= Jt[0].length), vt.push(new s(0, D - Jt[0].length, D)))),
                h == "rtl" ? vt.reverse() : vt
              );
            };
          })();
            ...
            if (Or == null) {
              ...
              (G(e, c("span", [t, document.createTextNode("x")])),
                e.firstChild.offsetHeight != 0 &&
                  (Or = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(k && I < 8)));
            }
            var n = Or
              ? c("span", "​")
              : c("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
          ...
          function sr(e) {
            ...
            return (F(e), !n || n.left == n.right ? !1 : (an = r.right - n.right < 3));
          }
          var zt =
              `
...
`,
          ...
          function f(e) {
            ...
            for (var t = e.parent, n = ve(t.lines, e), r = t.parent; r; t = r, r = r.parent)
          ...
          function Ae(e, t) {
            ...
            return t.line > n ? B(n, ye(e, n).text.length) : Za(t, ye(e, t.line).text.length);
          }
          function Za(e, t) {
            var n = e.ch;
                  ...
                  ((n.state = !0),
                    So(
                      ...
                      function (L, H) {
                        ...
                        if (H)
                          if (h.opaque) (i.splice(Z, x - Z, L, "overlay " + H), (x = Z + 2));
                          else
                            for (; Z < x; Z += 2) {
                              var ae = i[Z + 1];
            ...
            for (t == "" && wo(yo(n, r.state), o); !h.eol(); ) {
              if (
                (h.pos > e.options.maxHighlightLength
                  ? ((a = !1), l && bi(e, t, r, h.pos), (h.pos = t.length), (x = null))
            ...
            if (e)
              for (var i = 0; i < e.length; ++i) {
                ...
                if (a || (o.from == t && l.type == "bookmark" && (!n || o.marker.insertLeft))) {
                  ...
                  (r || (r = [])).push(
                    new _n(l, s ? null : o.from - t, o.to == null ? null : o.to - t)
                  );
                }
              }
            return r;
            ...
            if (!u) {
              ...
              if (he > 0 && a)
                for (var ge = 0; ge < a.length; ++ge)
                  a[ge].to == null && (se || (se = [])).push(new _n(a[ge].marker, null, null));
              ...
              (e.iter(t.line, n.line + 1, function (L) {
                if (L.markedSpans)
                  for (var H = 0; H < L.markedSpans.length; ++H) {
                    ...
                    Z.readOnly && (!r || ve(r, Z) == -1) && (r || (r = [])).push(Z);
                  }
              }),
              !r)
            )
              ...
              for (var l = r[o], a = l.find(0), s = 0; s < i.length; ++s) {
                ...
                if (!(ce(u.to, a.from) < 0 || ce(u.from, a.to) > 0)) {
                  var h = [s, 1],
                    x = ce(u.from, a.from),
                    D = ce(u.to, a.to);
                  ((x < 0 || (!l.inclusiveLeft && !x)) && h.push({ from: u.from, to: a.from }),
                    (D > 0 || (!l.inclusiveRight && !D)) && h.push({ from: a.to, to: u.to }),
                    i.splice.apply(i, h),
                    (s += h.length - 3));
                }
              }
          ...
          function Oo(e, t) {
              ...
              (xs(o, r, xo(e, o, a)),
                o.styleClasses &&
                  ...
                  o.styleClasses.textClass &&
                    (r.textClass = de(o.styleClasses.textClass, r.textClass || ""))),
                r.map.length == 0 && r.map.push(0, 0, r.content.appendChild(Rn(e.display.measure))),
                i == 0
            ...
            return (
              ...
              r.pre.className && (r.textClass = de(r.pre.className, r.textClass || "")),
              r
            );
          }
          function ps(e) {
              ...
              if (!s.test(t))
                ...
                for (var x = 0; ; ) {
                  ...
                  if (L) {
                    ...
                    (k && I < 9 ? h.appendChild(c("span", [H])) : h.appendChild(H),
                  ...
                  if (D[0] == "	") {
                    ...
                    D[0] ==
                      `
`
                      ? ((Z = h.appendChild(c("span", D[0] == "\r" ? "␍" : "␤", "cm-invalidchar"))),
                        Z.setAttribute("cm-text", D[0]),
                        (e.col += 1))
                      : ((Z = e.cm.options.specialCharPlaceholder(D[0])),
                        Z.setAttribute("cm-text", D[0]),
                        k && I < 9 ? h.appendChild(c("span", [Z])) : h.appendChild(Z),
                        (e.col += 1));
          ...
          function xs(e, t, n) {
            ...
            for (var a = i.length, s = 0, u = 1, h = "", x, D, L = 0, H, Z, ie, ae, he; ; ) {
              if (L == s) {
                ((H = Z = ie = D = ""), (he = null), (ae = null), (L = 1 / 0));
                for (var se = [], ge = void 0, Le = 0; Le < r.length; ++Le) {
                  var ke = r[Le],
                    Ee = ke.marker;
                  if (Ee.type == "bookmark" && ke.from == s && Ee.widgetNode) se.push(Ee);
                  else if (
                    ke.from <= s &&
                    (ke.to == null || ke.to > s || (Ee.collapsed && ke.to == s && ke.from == s))
                  ) {
                    if (
                      (ke.to != null && ke.to != s && L > ke.to && ((L = ke.to), (Z = "")),
                      Ee.className && (H += " " + Ee.className),
                      Ee.css && (D = (D ? D + ";" : "") + Ee.css),
                      Ee.startStyle && ke.from == s && (ie += " " + Ee.startStyle),
                      Ee.endStyle && ke.to == L && (ge || (ge = [])).push(Ee.endStyle, ke.to),
                      Ee.title && ((he || (he = {})).title = Ee.title),
                      Ee.attributes)
                    )
                      for (var Ke in Ee.attributes) (he || (he = {}))[Ke] = Ee.attributes[Ke];
                    Ee.collapsed && (!ae || Si(ae.marker, Ee) < 0) && (ae = ke);
                  } else ke.from > s && L > ke.from && (L = ke.from);
                }
                if (ge)
                  for (var st = 0; st < ge.length; st += 2) ge[st + 1] == L && (Z += " " + ge[st]);
                if (!ae || ae.from == s) for (var Xe = 0; Xe < se.length; ++Xe) Po(t, 0, se[Xe]);
                if (ae && (ae.from || 0) == s) {
                  if (
                    (Po(t, (ae.to == null ? a + 1 : ae.to) - s, ae.marker, ae.from == null),
                    ae.to == null)
                  )
                    return;
                  ae.to == s && (ae = !1);
              ...
              for (var Nt = Math.min(a, L); ; ) {
                if (h) {
                  ...
                  if (!ae) {
                    ...
                    t.addToken(t, tt, x ? x + H : H, ie, s + tt.length == L ? Z : "", D, he);
                  }
                  if (Tt >= Nt) {
                    ((h = h.slice(Nt - s)), (s = Nt));
                    break;
                ...
                ((h = i.slice(o, (o = n[u++]))), (x = Eo(n[u++], t.cm.options)));
              }
            }
          }
          function Io(e, t, n) {
          ...
          var _r = null;
          function ys(e) {
            _r ? _r.ops.push(e) : (e.ownsGroup = _r = { ops: [e], delayedCallbacks: [] });
          }
          function bs(e) {
          ...
          function ot(e, t) {
            ...
            if (n.length) {
              var r = Array.prototype.slice.call(arguments, 2),
                i;
              _r ? (i = _r.delayedCallbacks) : dn ? (i = dn) : ((i = dn = []), setTimeout(ws, 0));
              for (
                var o = function (a) {
                    i.push(function () {
          ...
          function Ts(e, t, n) {
            ...
            for (var r = P("CodeMirror-linewidget"), i = t.node.firstChild, o = void 0; i; i = o)
          ...
          function qr(e, t) {
            ...
            (r && !r.text
              ? (r = null)
              : r && r.changes && (zo(e, r, n, Ii(e)), (e.curOp.forceUpdate = !0)),
              r || (r = Fs(e, t)));
            var i = qo(r, t, n);
            return {
              line: t,
          ...
          function Ns(e, t, n, r) {
            ...
            if (o.nodeType == 3) {
              for (var h = 0; h < 4; h++) {
                ...
                for (; i.coverStart + a < i.coverEnd && Ne(t.line.text.charAt(i.coverStart + a)); )
                  ++a;
                if (
            ...
            return (
              ...
              e.options.singleCursorHeightPerLine || ((ge.rtop = L), (ge.rbottom = H)),
              ge
            );
          }
          function Es(e, t) {
          ...
          function Qn(e, t, n, r, i) {
            return (r || (r = ye(e.doc, t.line)), Yn(e, r, jo(e, r, t.ch, i), n));
          }
          function jt(e, t, n, r, i, o) {
            ((r = r || ye(e.doc, t.line)), i || (i = qr(e, r)));
            function l(H, Z) {
              var ie = Qt(e, i, H, Z ? "right" : "left", o);
              return (Z ? (ie.left = ie.right) : (ie.right = ie.left), Yn(e, r, ie, n));
            }
          ...
          function Zo(e, t) {
            var n = 0;
            ((t = Ae(e.doc, t)), e.options.lineWrapping || (n = Kr(e.display) * t.ch));
          ...
          function Oi(e, t, n) {
            var r = e.doc;
            if (((n += e.display.viewOffset), n < 0)) return Ei(r.first, 0, null, -1, -1);
            var i = m(r, n),
              o = r.first + r.size - 1;
            if (i > o) return Ei(r.first + r.size - 1, ye(r, o).text.length, null, 1, 1);
            t < 0 && (t = 0);
            for (var l = ye(r, i); ; ) {
              var a = Os(e, l, i, t, n),
          ...
          function Os(e, t, n, r, i) {
            ...
            if (h) {
              ...
              ((u = x.level != 1), (a = u ? x.from : x.to - 1), (s = u ? x.to : x.from - 1));
            }
            var D = null,
              L = null,
              H = Pt(
                function (Le) {
                  ...
                  return (
                    ...
                    (ke.bottom += l),
                    Pi(ke, r, i, !1)
                      ? (ke.top <= i && ke.left <= r && ((D = Le), (L = ke)), !0)
                      : !1
                  );
                },
                a,
            ...
            if (L) {
              var he = r - L.left < L.right - r,
                se = he == u;
              ((H = D + (se ? 0 : 1)), (ie = se ? "after" : "before"), (Z = he ? L.left : L.right));
            } else {
              (!u && (H == s || H == a) && H++,
                (ie =
                  H == 0
          ...
          function Ps(e, t, n, r, i, o, l) {
            var a = Pt(
                function (x) {
                  var D = i[x],
                    L = D.level != 1;
                  return Pi(
                    jt(e, B(n, L ? D.to : D.from, L ? "before" : "after"), "line", t, r),
                    o,
                    l,
                    !0
                  );
            ...
            if (a > 0) {
              var u = s.level != 1,
                h = jt(e, B(n, u ? s.from : s.to, u ? "after" : "before"), "line", t, r);
          ...
          function Is(e, t, n, r, i, o, l) {
            ...
            for (var h = null, x = null, D = 0; D < i.length; D++) {
              ...
              if (!(L.from >= u || L.to <= s)) {
                var H = L.level != 1,
                  Z = Qt(e, r, H ? Math.min(u, L.to) - 1 : Math.max(s, L.from)).right,
                  ie = Z < o ? o - Z + 1e9 : Z - o;
                (!h || x > ie) && ((h = L), (x = ie));
              }
            }
          ...
          function jr(e) {
            ...
            if (Sr == null) {
              ...
              for (var t = 0; t < 49; ++t)
                (Sr.appendChild(document.createTextNode("x")), Sr.appendChild(c("br")));
          ...
          function Lr(e, t, n, r) {
            ...
            var s = Oi(e, o, l),
              u;
            if (r && s.xRel > 0 && (u = ye(e.doc, s.line).text).length == s.ch) {
              var h = Fe(u, u.length, e.options.tabSize) - u.length;
              s = B(s.line, Math.max(0, Math.round((o - _o(e.display).left) / Kr(e.display)) - h));
            }
            return s;
          }
          function Tr(e, t) {
          ...
          function St(e, t, n, r) {
            ...
            if (
              ...
              $t && No(e.doc, n + r) > i.viewFrom ? hr(e) : ((i.viewFrom += r), (i.viewTo += r));
              ...
              if (!(!t && a == n.sel.primIndex)) {
                ...
                if (!(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)) {
                  ...
                  if (l) {
                    var h = l(e, s);
                    h && Ri(e, h, i);
                  } else (u || e.options.showCursorWhenSelecting) && Ri(e, s.head, i);
                  u || Bs(e, s, o);
                }
              }
            return r;
          ...
          function Bs(e, t, n) {
            ...
            if (D.line == L.line) x(D.line, D.ch, L.ch);
              ...
              (ie &&
                (ae.top < he.top - 2
                  ? (h(ae.right, ae.top, null, ae.bottom), h(a, he.top, he.left, he.bottom))
              ...
              if (!a.hidden) {
                if (((i += a.line.height), k && I < 8)) {
                  ...
                  ((u = D.bottom - D.top),
                    !s &&
                      a.text.firstChild &&
                      (h = a.text.firstChild.getBoundingClientRect().right - D.left - 1));
                }
          ...
          function Ws(e, t, n, r) {
            ...
            for (var o = 0; o < 5; o++) {
              ...
              if (
                ...
                u.scrollLeft != null &&
                  (Cr(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - x) > 1 && (l = !0)),
                !l)
              )
                break;
            }
            ...
            return (
              ...
              t.left < 10
                ...
                : t.left < D
                  ...
                  : t.right > L + D - 3 && (l.scrollLeft = t.right + (H ? 0 : 10) - L),
              l
            );
          }
          function ji(e, t) {
          ...
          var Dr = function (e, t, n) {
            ...
            ((r.tabIndex = i.tabIndex = -1),
              ...
              k && I < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px"));
          };
          ...
          function ul(e) {
            (e.display.scrollbars &&
              ...
              e.display.scrollbars.addClass && $(e.display.wrapper, e.display.scrollbars.addClass)),
              ...
              e.display.scrollbars.addClass && j(e.display.wrapper, e.display.scrollbars.addClass));
          }
          var qs = 0;
          function Mr(e) {
            ((e.curOp = {
          ...
          function Gs(e) {
            ...
            (e.updatedDisplay && Vn(t),
              ...
              n.maxLineChanged &&
                ...
                ((e.adjustWidthTo = jo(t, n.maxLine, n.maxLine.text.length).left + 3),
          ...
          function kn(e, t) {
            e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, xe(Qs, e));
          }
          function Qs(e) {
            var t = e.doc;
              ...
              (t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
                if (r.line >= e.display.viewFrom) {
                  ...
                  for (
                    ...
                    x = l[D] != o.styles[D];
                  (x && i.push(r.line), (o.stateAfter = r.save()), r.nextLine());
                } else
            ...
            for (var s = r.view, u = r.viewFrom, h = 0; h < s.length; h++) {
              ...
              if (!x.hidden)
                if (!x.node || x.node.parentNode != o) {
                  ...
                  (x.changes && (ve(x.changes, "gutter") > -1 && (L = !1), zo(e, x, u, n)),
                    L &&
                      (F(x.lineNumber),
                      x.lineNumber.appendChild(document.createTextNode(re(e.options, u)))),
          ...
          function dl(e) {
            ...
            if (n.length != r.lineNumChars) {
              var i = r.measure.appendChild(
                  c("div", [c("div", n)], "CodeMirror-linenumber CodeMirror-gutter-elt")
                ),
          ...
          function eu(e, t, n, r) {
            ...
            ((i.mover = c("div", [o], null, "position: relative")),
              ...
              k && I < 8 && ((i.gutters.style.zIndex = -1), (i.scroller.style.paddingRight = 0)),
          ...
          var ri = 0,
            rr = null;
          k ? (rr = -0.53) : _ ? (rr = 15) : S ? (rr = -0.7) : V && (rr = -1 / 3);
          function pl(e) {
            var t = e.wheelDeltaX,
              n = e.wheelDeltaY;
            return (
          ...
          function gl(e, t) {
            ...
            if ((r && s) || (i && u)) {
              ...
              if (i && o != null) {
                ...
                (L < 0 ? (H = Math.max(0, H + L - 50)) : (Z = Math.min(e.doc.height, Z + L + 50)),
                  Ui(e, { top: H, bottom: Z }));
              }
              ri < 20 &&
                t.deltaMode !== 0 &&
          ...
          function ru(e, t, n) {
            for (var r = [], i = B(e.first, 0), o = i, l = 0; l < t.length; l++) {
              var a = t[l],
                s = ml(a.from, i, o),
                u = ml(gr(a), i, o);
          ...
          function Zi(e, t, n, r) {
            ...
            function l(he, se) {
              for (var ge = [], Le = he; Le < se; ++Le) ge.push(new Hr(u[Le], i(Le), r));
              return ge;
            }
            var a = t.from,
              s = t.to,
            ...
            if (t.full) (e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length));
              ...
              (o(x, x.text, L), H && e.remove(a.line, H), Z.length && e.insert(a.line, Z));
            } else if (h == x)
              if (u.length == 1) o(h, h.text.slice(0, a.ch) + D + h.text.slice(s.ch), L);
              else {
              ...
              (o(h, h.text.slice(0, a.ch) + u[0], i(0)), o(x, D + x.text.slice(s.ch), L));
          ...
          function bl(e) {
            (e.doc.direction == "rtl" ? j : $)(e.display.lineDiv, "CodeMirror-rtl");
          }
          function nu(e) {
            At(e, function () {
              (bl(e), St(e));
          ...
          function lu(e, t, n, r) {
            ...
            (o &&
              i.lastSelOrigin == o &&
              ((i.lastModTime == i.lastSelTime && i.lastOrigin == o) || ou(e, o, we(i.done), t)))
          ...
          function $i(e, t, n, r) {
            if (r) {
              ...
              if (n) {
                var o = ce(t, i) < 0;
                o != ce(n, i) < 0 ? ((i = t), (t = n)) : o != ce(t, n) < 0 && (t = n);
              }
              return new He(i, t);
          ...
          function li(e, t, n) {
            (Ft(e, "beforeSelectionChange") || (e.cm && Ft(e.cm, "beforeSelectionChange"))) &&
              (t = uu(e, t, n));
                ...
                if (
                  ...
                  if (n) {
                    var x = s.find(r < 0 ? 1 : -1),
                      D = void 0;
                    if (
                      ((r < 0 ? h : u) && (x = Nl(e, x, -r, x && x.line == t.line ? o : null)),
                      x && x.line == t.line && (D = ce(x, n)) && (r < 0 ? D < 0 : D > 0))
                    )
                      return Qr(e, x, t, r, i);
                  }
                  var L = s.find(r < 0 ? -1 : 1);
                  return (
                    (r < 0 ? u : h) && (L = Nl(e, L, r, L.line == t.line ? o : null)),
                    L ? Qr(e, L, t, r, i) : null
                  );
                }
              }
          ...
          function Pl(e, t) {
            if (!(t.text.length == 1 && t.text[0] == "" && ce(t.from, t.to) == 0)) {
              var n = Qi(e, t);
              (wl(e, t, n, e.cm ? e.cm.curOp.id : NaN), Ln(e, t, n, wi(e, t)));
              var r = [];
              vr(e, function (i, o) {
                (!o && ve(r, i.history) == -1 && (Rl(i.history, t), r.push(i.history)),
                  Ln(i, t, null, wi(i, t)));
              });
            }
          }
          function si(e, t, n) {
            ...
            if (!(r && !n)) {
              ...
              if (u != a.length) {
                ...
                for (
                  var x = Ft(e, "beforeChange") || (e.cm && Ft(e.cm, "beforeChange")),
                    D = function (Z) {
                      var ie = o.changes[Z];
                      if (((ie.origin = t), x && !Ol(e, ie, !1))) return ((a.length = 0), {});
                      h.push(Vi(e, ie));
                      var ae = Z ? Qi(e, ie) : we(a);
                      (Ln(e, ie, ae, Ll(e, ie)),
                        !Z && e.cm && e.cm.scrollIntoView({ from: ie.from, to: gr(ie) }));
                      var he = [];
                      vr(e, function (se, ge) {
                        (!ge &&
                          ve(he, se.history) == -1 &&
            ...
            if (
              ...
              (e.sel = new Ot(
                Ie(e.sel.ranges, function (i) {
                  return new He(B(i.anchor.line + t, i.anchor.ch), B(i.head.line + t, i.head.ch));
                }),
                e.sel.primIndex
              )),
              e.cm)
            ...
            (e.options.lineWrapping ||
              ...
              e.options.lineWrapping ||
                (r.iter(s, o.line + t.text.length, function (L) {
                  var H = Un(L);
                  H > i.maxLineLength &&
                    ((i.maxLine = L), (i.maxLineLength = H), (i.maxLineChanged = !0), (a = !1));
                }),
            ...
            for (var i = 0; i < e.length; ++i) {
              ...
              if (o.ranges) {
                ...
                for (var a = 0; a < o.ranges.length; a++)
                  (zl(o.ranges[a].anchor, t, n, r), zl(o.ranges[a].head, t, n, r));
                continue;
              }
            ...
            return (
              ...
              Tn(e, t, "widget", function (l) {
                ...
                if (
                  ...
                  (Et(l, l.height + pn(i)), s && ji(o, i.height), (o.curOp.forceUpdate = !0));
                }
                return !0;
              }),
          ...
          ((mr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
              ...
              (r != null && e && this.collapsed && St(e, r, i + 1),
                ...
                this.atomic && this.doc.cantEdit && ((this.doc.cantEdit = !1), e && Fl(e.doc)),
            ...
            (mr.prototype.find = function (e, t) {
              ...
              for (var n, r, i = 0; i < this.lines.length; ++i) {
                ...
                if (l.from != null && ((n = B(t ? o : f(o), l.from)), e == -1)) return n;
                if (l.to != null && ((r = B(t ? o : f(o), l.to)), e == 1)) return r;
              }
              ...
              !t ||
                ...
                At(r, function () {
                  var i = t.line,
                    ...
                    l = Ai(r, o);
                  if (
                    (l && (Go(l), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
            ...
            (mr.prototype.attachLine = function (e) {
              if (!this.lines.length && this.doc.cm) {
                ...
                (!t.maybeHiddenMarkers || ve(t.maybeHiddenMarkers, this) == -1) &&
          ...
          function Vr(e, t, n, r, i) {
            ...
            var o = new mr(e, i),
              l = ce(t, n);
            if ((r && Me(r, o, !1), l > 0 || (l == 0 && o.clearWhenEmpty !== !1))) return o;
            if (
              (o.replacedWith &&
                ((o.collapsed = !0),
                (o.widgetNode = T("span", [o.replacedWith], "CodeMirror-widget")),
            ...
            o.addToHistory && wl(e, { from: t, to: n, origin: "markText" }, e.sel, NaN);
            var a = t.line,
              s = e.cm,
              u;
            if (
              (e.iter(a, n.line + 1, function (x) {
                (s &&
                  ...
                  ns(
                    x,
                    new _n(o, a == t.line ? t.ch : null, a == n.line ? n.ch : null),
                    e.cm && e.cm.curOp
                  ),
                  ++a);
              }),
              ...
              o.readOnly &&
                (es(), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
              o.collapsed && ((o.id = ++Hl), (o.atomic = !0)),
              s)
            ) {
              if ((u && (s.curOp.updateMaxLine = !0), o.collapsed)) St(s, t.line, n.line + 1);
              else if (
                o.className ||
                o.startStyle ||
                o.endStyle ||
          ...
          function du(e, t, n, r, i) {
            ...
            return (
              vr(e, function (s) {
                (a && (r.widgetNode = a.cloneNode(!0)), o.push(Vr(s, Ae(s, t), Ae(s, n), r, i)));
            ...
            for (
              var t = function (r) {
                  ...
                  for (var l = 0; l < i.markers.length; l++) {
                    var a = i.markers[l];
                    ve(o, a.doc) == -1 && ((a.parent = null), i.markers.splice(l--, 1));
                  }
                },
                n = 0;
              n < e.length;
          ...
          ((Lt.prototype = K(Dn.prototype, {
            ...
            replaceRange: function (e, t, n, r) {
              ((t = Ae(this, t)), (n = n ? Ae(this, n) : t), Zr(this, e, t, n, r));
            },
            ...
            setCursor: at(function (e, t, n) {
              Cl(this, Ae(this, typeof e == "number" ? B(e, t || 0) : e), null, n);
            }),
            ...
            setSelections: at(function (e, t, n) {
              if (e.length) {
                for (var r = [], i = 0; i < e.length; i++)
                  r[i] = new He(Ae(this, e[i].anchor), Ae(this, e[i].head || e[i].anchor));
            ...
            replaceSelections: at(function (e, t, n) {
              ...
              for (var a = t && t != "end" && ru(this, r, t), s = r.length - 1; s >= 0; s--)
                Jr(this, r[s]);
            ...
            markText: function (e, t, n) {
              return Vr(this, Ae(this, e), Ae(this, t), n, (n && n.type) || "range");
            },
...
`
                      ...
                      a = function () {
                        ++l == i &&
                          lt(t, function () {
                            ...
                            (Jr(t.doc, L), Dl(t.doc, pr(Ae(t.doc, n), Ae(t.doc, gr(L)))));
                          })();
                      },
                      s = function (L, H) {
                        if (
          ...
          for (var Nn = 1; Nn <= 12; Nn++) xr[Nn + 111] = xr[Nn + 63235] = "F" + Nn;
          var nr = {};
          ((nr.basic = {
            Left: "goCharLeft",
            Right: "goCharRight",
          ...
          function en(e, t) {
            ...
            At(e, function () {
              for (var a = r.length - 1; a >= 0; a--) Zr(e.doc, "", r[a].from, r[a].to, "+delete");
              Gr(e);
            });
          }
          function to(e, t, n) {
          ...
          function Lu(e, t, n, r) {
            ...
            if (e.doc.direction == "rtl" || l.level == 1) {
              var x = (l.level == 1) == r < 0,
                D = a(n, x ? 1 : -1);
              if (D != null && (x ? D <= l.to && D <= h.end : D >= l.from && D >= h.begin)) {
            ...
            var H = function (ae, he, se) {
                for (
                  var ge = function (Ke, st) {
                    return st ? new B(n.line, a(Ke, 1), "before") : new B(n.line, Ke, "after");
                  };
                  ae >= 0 && ae < i.length;
                  ae += he
                ) {
                  ...
                  if (
                    (Le.from <= Ee && Ee < Le.to) ||
                    ((Ee = ke ? Le.from : a(Le.to, -1)), se.begin <= Ee && Ee < se.end)
                  )
                    return ge(Ee, ke);
                }
              },
          ...
          var En = {
            ...
            deleteLine: function (e) {
              return en(e, function (t) {
                return { from: B(t.from().line, 0), to: Ae(e.doc, B(t.to().line + 1, 0)) };
              });
            },
...
`,
          ...
          function $l(e) {
            ...
            if (
              ...
              (A &&
                ...
                n == 18 && !/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) && Fu(t));
            }
          }
          function Fu(e) {
          ...
          function ta(e) {
            ...
            if (
              !(e.target && e.target != t.display.input.getField()) &&
              !(tr(t.display, e) || Qe(t, e) || (e.ctrlKey && !e.altKey) || (z && e.metaKey))
            ) {
              var n = e.keyCode,
                r = e.charCode;
              if (A && n == io) {
          ...
          oo.prototype.compare = function (e, t, n) {
            return this.time + Au > e && ce(t, this.pos) == 0 && n == this.button;
          };
          var Pn, In;
          function Nu(e, t) {
            var n = +new Date();
                  ...
                  !(r && Eu(t, i, r, o, e)) &&
                    (i == 1
                      ...
                      : i == 2
                        ...
                        : i == 3 && (J ? t.display.input.onContextMenu(e) : Hi(t))));
              }
            }
          }
          ...
          function Ou(e, t, n) {
            ...
            return (
              ...
              i.moveOnDrag == null && (i.moveOnDrag = !(z ? n.altKey : n.ctrlKey)),
              i
            );
          }
          function Pu(e, t, n, r) {
          ...
          function na(e, t, n) {
            ...
            if (n == "line") return new He(B(t.line, 0), Ae(e.doc, B(t.line + 1, 0)));
            var r = n(e, t);
          ...
          function zu(e, t, n, r) {
            ...
            r.addNew
              ? a == -1
                ? ((a = u.length), gt(o, Kt(e, u.concat([l]), a), { scroll: !1, origin: "*mouse" }))
                ...
                if (((x = se), r.unit == "rectangle")) {
                  for (
                    ...
                    Ke == st
                      ...
                      : Tt.length > tt && ge.push(new He(B(Xe, tt), B(Xe, _e(Tt, st, Le))));
                  }
                  ...
                  ((Ze[a] = Bu(e, new He(Ae(o, nt), rt))), gt(o, Kt(e, Ze, a), dt));
                }
            }
            ...
            function Z(se) {
              ...
              if (Le)
                if (ce(Le, x) != 0) {
                  ...
                  var Ee = se.clientY < L.top ? -20 : se.clientY > L.bottom ? 20 : 0;
                  Ee &&
                    setTimeout(
                      lt(e, function () {
          ...
          function Bu(e, t) {
            ...
            var D = o[s + (u ? -1 : 0)],
              ...
              H = L ? D.from : D.to,
              Z = L ? "after" : "before";
            return n.ch == H && n.sticky == Z ? t : new He(new B(n.line, H, Z), r);
          }
          function ia(e, t, n, r) {
            var i, o;
          ...
          function Ru(e, t) {
            return Ft(e, "gutterContextMenu") ? ia(e, t, "gutterContextMenu", !1) : !1;
          }
          function la(e) {
          ...
          function zn(e, t, n, r) {
            ...
            if ((D < h && (x += et(h - D)), x != u))
              return (Zr(i, x, B(t, 0), B(t, u.length), "+input"), (a.stateAfter = null), !0);
...
`) == t
            ...
            for (var x = e.curOp.updateInput, D = r.ranges.length - 1; D >= 0; D--) {
              var L = r.ranges[D],
                H = L.from(),
                Z = L.to();
              L.empty() &&
                (n && n > 0
                  ? (H = B(H.line, H.ch - n))
                  : e.state.overwrite && !a
                    ? (Z = B(Z.line, Math.min(ye(o, Z.line).text.length, Z.ch + we(s).length)))
                    : a &&
                      Ut &&
                      Ut.lineWise &&
                      Ut.text.join(`
...
`) &&
          ...
          function ju(e) {
            ...
            ((e.prototype = {
              ...
              getStateAfter: function (r, i) {
                var o = this.doc;
                return ((r = go(o, r ?? o.first + o.size - 1)), fn(this, r + 1, i).state);
              },
              ...
              addWidget: function (r, i, o, l, a) {
                ...
                if (
                  ...
                  ((l == "above" || r.bottom + i.offsetHeight > x) && r.top > i.offsetHeight
              ...
              findPosV: function (r, i, o, l) {
                ...
                for (var u = Ae(this.doc, r), h = 0; h < i; ++h) {
                  var x = jt(this, u, "div");
                  if ((s == null ? (s = x.left) : (x.left = s), (u = da(this, x, a, o)), u.hitSide))
                    break;
                }
                return u;
              },
              moveV: yt(function (r, i) {
                ...
                if (
                  (l.extendSelectionsBy(function (h) {
                    ...
                    (h.goalColumn != null && (x.left = h.goalColumn), a.push(x.left));
                    var D = da(o, x, r, i);
                    return (
                      i == "page" && h == l.sel.primary() && ji(o, Qn(o, D, "div").top - x.top),
                      D
                    );
                  }, Pe),
                  a.length)
              ...
              scrollIntoView: yt(function (r, i) {
                (r == null
                  ...
                  r.to || (r.to = r.from),
                  (r.margin = i || 0),
                  r.from.line != null ? _s(this, r) : ol(this, r.from, r.to, r.margin));
              }),
          ...
          function fo(e, t, n, r, i) {
            ...
            function h(he) {
              ...
              if (r == "codepoint") {
                ...
                if (isNaN(ge)) se = null;
                  ...
                  var Le = n > 0 ? ge >= 55296 && ge < 56320 : ge >= 56320 && ge < 57343;
                  se = new B(
                    t.line,
                    Math.max(0, Math.min(a.text.length, t.ch + n * (Le ? 2 : 1))),
                    -n
                  );
                }
            ...
            if (r == "char" || r == "codepoint") h();
              ...
              for (
                var x = null, D = r == "group", L = e.cm && e.cm.getHelper(t, "wordChars"), H = !0;
                !(n < 0 && !h(!H));
                H = !1
              ) {
                var Z =
...
`)));
            ...
            (je.prototype.showPrimarySelection = function () {
              ...
              if (!(o && !o.bad && l && !l.bad && ce(Wr(o, l), r) == 0 && ce(wt(o, l), i) == 0)) {
                ...
                if (!u) {
                  ...
                  u = { node: x[x.length - 1], offset: x[x.length - 2] - x[x.length - 3] };
                }
                if (!s || !u) {
                  e.removeAllRanges();
                  return;
                ...
                (L &&
                  ...
                  D && e.anchorNode == null ? e.addRange(D) : _ && this.startGracePeriod()),
            ...
            (je.prototype.pollSelection = function () {
              if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
                var e = this.getSelection(),
                  t = this.cm;
                if (M && S && this.cm.display.gutterSpecs.length && Ku(e.anchorNode)) {
            ...
            (je.prototype.pollContent = function () {
              ...
              for (
                var L = 0, H = 0, Z = x[0], ie = D[0], ae = Math.min(Z.length, ie.length);
              ...
              for (
                ...
                H < ge && he.charCodeAt(he.length - H - 1) == se.charCodeAt(se.length - H - 1);
              )
                ++H;
              if (x.length == 1 && D.length == 1 && l == r.line)
                for (
                  ...
                  L &&
                  L > r.ch &&
                  he.charCodeAt(he.length - H - 1) == se.charCodeAt(se.length - H - 1);
                )
                  (L--, H++);
              ((x[x.length - 1] = he.slice(0, he.length - H).replace(/^\u200b+/, "")),
                (x[0] = x[0].slice(L).replace(/\u200b+$/, "")));
              var Le = B(l, L),
                ke = B(u, D.length ? we(D).length - H : 0);
              if (x.length > 1 || x[0] || ce(Le, ke)) return (Zr(e.doc, x, Le, ke, "+input"), !0);
            }),
            ...
            function D(L) {
              if (L.nodeType == 1) {
                ...
                if (Z) {
                  ...
                  ae.length && (ie = ae[0].find(0)) && x(Vt(e.doc, ie.from, ie.to).join(a));
                  return;
                }
                if (L.getAttribute("contenteditable") == "false") return;
                var he = /^(pre|div|p|li|table|br)$/i.test(L.nodeName);
                if (!/^br$/i.test(L.nodeName) && L.textContent.length == 0) return;
                he && h();
                for (var se = 0; se < L.childNodes.length; se++) D(L.childNodes[se]);
                (/^(pre|p)$/i.test(L.nodeName) && (s = !0), he && (l = !0));
              } else
                L.nodeType == 3 && x(L.nodeValue.replace(/\u200b/g, "").replace(/\u00a0/g, " "));
            }
          ...
          function Gu(e, t, n) {
            ...
            function h(ie, ae, he) {
              for (var se = -1; se < (u ? u.length : 0); se++)
                for (var ge = se < 0 ? s.map : u[se], Le = 0; Le < ge.length; Le += 3) {
                  var ke = ge[Le + 2];
                  if (ke == ie || ke == ae) {
                    var Ee = f(se < 0 ? e.line : e.rest[se]),
                      Ke = ge[Le] + he;
                    return ((he < 0 || ke != ie) && (Ke = ge[Le + (he ? 1 : 0)]), B(Ee, Ke));
                  }
                }
            }
            var x = h(l, a, n);
            if (x) return rn(x, i);
            for (var D = a.nextSibling, L = l ? l.nodeValue.length - n : 0; D; D = D.nextSibling) {
              if (((x = h(D, D.firstChild, 0)), x)) return rn(B(x.line, x.ch - L), i);
              L += D.textContent.length;
            }
            for (var H = a.previousSibling, Z = n; H; H = H.previousSibling) {
              if (((x = h(H, H.firstChild, -1)), x)) return rn(B(x.line, x.ch + Z), i);
          ...
          (($e.prototype.init = function (e) {
            ...
            (e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
              w && (i.style.width = "0px"),
              Se(i, "input", function () {
                (k && I >= 9 && t.hasSelection && (t.hasSelection = null), n.poll());
              }),
              Se(i, "paste", function (l) {
                Qe(r, l) || sa(l, r) || ((r.state.pasteIncoming = +new Date()), n.fastPoll());
              }));
            function o(l) {
              if (!Qe(r, l)) {
...
`)),
            ...
            ($e.prototype.poll = function () {
              ...
              if ((k && I >= 9 && this.hasSelection === i) || (z && /[\uf700-\uf7ff]/.test(i)))
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`));
              ...
              function L() {
                if (
                  ...
                  (i.style.cssText = s),
                  k && I < 9 && r.scrollbars.setScrollTop((r.scroller.scrollTop = l)),
          ...
          function Xu(e, t) {
            ...
            var i;
            if (e.form && (Se(e.form, "submit", r), !t.leaveSubmitMethodAlone)) {
              var o = e.form;
              i = o.submit;
              try {
        ...
        (function (b) {
          ...
          b.defineMode("css", function (J, P) {
            ...
            function Pe(E, ee, K, ze) {
              return (
                (E.context = new dt(K, ee.indentation() + (ze === !1 ? 0 : F), E.context)),
                K
              );
            }
            function _e(E) {
            ...
            return (
              (Ie.top = function (E, ee, K) {
                ...
                if (xe && /@component/i.test(E)) return Pe(K, ee, "atComponentBlock");
                if (/^@(-moz-)?document$/i.test(E)) return Pe(K, ee, "documentTypes");
                ...
                if (E == "word") {
                  ...
                  return y.hasOwnProperty(ze)
                    ...
                    : j.hasOwnProperty(ze)
                      ...
                      : Te
                        ? ((Ce = ee.match(/^\s*:(?:\s|$)/, !1) ? "property" : "tag"), "block")
                        : ((Ce += " error"), "maybeprop");
                } else
                  return E == "meta"
                    ? "block"
              ...
              (Ie.prop = function (E, ee, K) {
                ...
                if (
                  E == "hash" &&
                  !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(ee.current())
                )
                  Ce += " error";
              ...
              (Ie.at = function (E, ee, K) {
                return E == ";"
                  ...
                  : E == "{" || E == "}"
                    ? et(E, ee, K)
                    : (E == "word" ? (Ce = "tag") : E == "hash" && (Ce = "builtin"), "at");
              }),
                  ...
                  return (
                    ...
                    K.prev &&
                      ...
                      (K.type == "block" ||
                        ...
                        : ((ze == ")" && (K.type == "parens" || K.type == "atBlock_parens")) ||
                            (ze == "{" && (K.type == "at" || K.type == "atBlock"))) &&
          ...
          function pe(J) {
            for (var P = {}, $ = 0; $ < J.length; ++$) P[J[$].toLowerCase()] = !0;
            return P;
          }
          var _ = ["domain", "regexp", "url", "url-prefix"],
            ...
            q = pe(X),
            p = _.concat(oe).concat(k).concat(Y).concat(S).concat(A).concat(N).concat(X);
        ...
        (function (b) {
          ...
          (b.defineMode("xml", function (te, oe) {
            ...
            function A(c, T) {
              ...
              if (C == "<") {
                ((T.tokenize = R), (T.state = X), (T.tagName = T.tagStart = null));
                var g = T.tokenize(c, T);
                return g ? g + " tag error" : "tag error";
              } else
                return /[\'\"]/.test(C)
                  ? ((T.tokenize = V(C)), (T.stringStartCol = c.column()), T.tokenize(c, T))
                  : (c.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), "word");
            }
            function V(c) {
              var T = function (C, g) {
            ...
            function O(c) {
              return function (T, C) {
                for (var g; (g = T.next()) != null; ) {
                  if (g == "<") return ((C.tokenize = O(c + 1)), C.tokenize(T, C));
                  if (g == ">")
                    if (c == 1) {
                      C.tokenize = R;
                      break;
            ...
            function M(c, T, C) {
              ((this.prev = c.context),
                ...
                (this.startOfLine = C),
                (k.doNotIndent.hasOwnProperty(T) || (c.context && c.context.noIndent)) &&
                  (this.noIndent = !0));
            }
            function N(c) {
            ...
            function X(c, T, C) {
              return c == "openTag" ? ((C.tagStart = T.column()), q) : c == "closeTag" ? p : X;
            }
            function q(c, T, C) {
              return c == "word"
            ...
            function $(c, T, C) {
              return c == "equals" ? F : (k.allowMissing || (S = "error"), P(c, T, C));
            }
            function F(c, T, C) {
              return c == "string"
                ? G
            ...
            return {
              ...
              token: function (c, T) {
                if ((!T.tagName && c.sol() && (T.indented = c.indentation()), c.eatSpace()))
                  return null;
                ne = null;
              ...
              indent: function (c, T, C) {
                ...
                if (c.tokenize.isInAttribute)
                  return c.tagStart == c.indented ? c.stringStartCol + 1 : c.indented + Q;
                if (g && g.noIndent) return b.Pass;
                if (c.tokenize != A && c.tokenize != R) return C ? C.match(/^(\s*)/)[0].length : 0;
                if (c.tagName)
                ...
                if (y && y[1])
                  for (; g; )
                    if (g.tagName == y[2]) {
                      g = g.prev;
                      break;
                    } else if (k.implicitlyClosed.hasOwnProperty(w(g.tagName))) g = g.prev;
                    else break;
                else if (y)
                  for (; g; ) {
        ...
        (function (b) {
          ...
          (b.defineMode("javascript", function (pe, _) {
            ...
            function M(f, m) {
              ...
              if (U == "#" && f.peek() == "!") return (f.skipToEnd(), w("meta", "meta"));
              if (U == "#" && f.eatWhile(ne)) return w("variable", "property");
              if (
                (U == "<" && f.match("!--")) ||
                (U == "-" && f.match("->") && !/\S/.test(f.string.slice(0, f.start)))
              )
              ...
              if (R.test(U))
                return (
                  (U != ">" || !m.lexical || m.lexical.type != ">") &&
                    (f.eat("=")
                      ? (U == "!" || U == "=") && f.eat("=")
                      : /[<>*+\-|&?]/.test(U) && (f.eat(U), U == ">" && f.eat(U))),
                  U == "?" && f.eat(".") ? w(".") : w("operator", "operator", f.current())
                );
              if (ne.test(U)) {
                f.eatWhile(ne);
                var re = f.current();
            ...
            function N(f) {
              return function (m, U) {
                ...
                for (; (B = m.next()) != null && !(B == f && !re); ) re = !re && B == "\\";
            ...
            function P(f, m) {
              if (!I) return !1;
              for (var U = f.localVars; U; U = U.next) if (U.name == m) return !0;
            ...
            function $(f, m, U, re, B) {
              ...
              for (
                ...
                if (We(U, re)) {
                  ...
                  return F.marked ? F.marked : U == "variable" && P(f, re) ? "variable-2" : m;
                }
              }
            }
            var F = { state: null, marked: null, cc: null };
            function G() {
              for (var f = arguments.length - 1; f >= 0; f--) F.cc.push(arguments[f]);
            }
            function c() {
            ...
            function C(f) {
              ...
              if (((F.marked = "def"), !!I)) {
                ...
                _.globalVars && !T(f, m.globalVars) && (m.globalVars = new de(f, m.globalVars));
              }
            }
            function g(f, m) {
              if (m)
                ...
                } else return T(f, m.vars) ? m : new j(m.prev, new de(f, m.vars), !1);
              else return null;
            }
            function y(f) {
              return (
            ...
            function d() {
              ((F.state.context = new j(F.state.context, F.state.localVars, !1)),
                (F.state.localVars = v));
            }
            function fe() {
              ((F.state.context = new j(F.state.context, F.state.localVars, !0)),
            ...
            function le(f, m) {
              var U = function () {
                ...
                if (re.lexical.type == "stat") B = re.lexical.indented;
                  ...
                  for (var ce = re.lexical; ce && ce.type == ")" && ce.align; ce = ce.prev)
                    B = ce.indented;
                              ...
                              : f == "function"
                                ...
                                : f == "for"
                                  ...
                                  : f == "class" || (Y && m == "interface")
                                    ? ((F.marked = "keyword"),
                                      c(le("form", f == "class" ? f : m), Pr, xe))
                                    : f == "variable"
                                      ? Y && m == "declare"
                                        ? ((F.marked = "keyword"), c(Fe))
                                        : Y &&
                                            (m == "module" || m == "enum" || m == "type") &&
                                            F.stream.match(/^\s*\w/, !1)
                                          ? ((F.marked = "keyword"),
                                            m == "enum"
                                              ? c(ye)
                                              : m == "type"
                                                ? c(Wn, Me("operator"), Re, Me(";"))
                                                : c(le("form"), kt, Me("{"), le("}"), Pt, xe, xe))
                                          : Y && m == "namespace"
                                            ? ((F.marked = "keyword"), c(le("form"), ve, Fe, xe))
                                            : Y && m == "abstract"
                                              ? ((F.marked = "keyword"), c(Fe))
                                              : c(le("stat"), ze)
                                      : f == "switch"
            ...
            function Ve(f, m, U) {
              if (F.state.fatArrowAt == F.stream.start) {
                var re = U ? Ie : we;
                if (f == "(") return c(d, le(")"), Ne(Wt, ")"), xe, Me("=>"), re, Te);
            ...
            function Ue(f, m) {
              return f != "quasi" ? G() : m.slice(m.length - 2) != "${" ? c(Ue) : c(dt, et);
            }
            function et(f) {
              if (f == "}") return ((F.marked = "string-2"), (F.state.tokenize = X), c(Ue));
            }
            function we(f) {
            ...
            function De(f, m) {
              ...
              if (f == "variable" || F.style == "keyword") {
                if (((F.marked = "property"), m == "get" || m == "set")) return c(be);
                var U;
                return (
                  Y &&
                ...
                if (f == "number" || f == "string")
                  return ((F.marked = Q ? "property" : F.style + " property"), c(Be));
            ...
            function Ne(f, m, U) {
              function re(B, ce) {
                ...
                return B == m || ce == m ? c() : U && U.indexOf(";") > -1 ? G(f) : c(Me(m));
              }
            ...
            function Mt(f, m, U) {
              for (var re = 3; re < arguments.length; re++) F.cc.push(arguments[re]);
            ...
            function lr(f) {
              if (Y && f == ":")
                return F.stream.match(/^\s*\w+\s+is\b/, !1) ? c(ve, mi, Re) : c(Re);
            }
            function mi(f, m) {
            ...
            function Re(f, m) {
              ...
              if (f == "variable" || m == "void") return ((F.marked = "type"), c(It));
              if (m == "|" || m == "&") return c(Re);
            ...
            function Ye(f) {
              if (f == "}") return ((F.marked = "string-2"), (F.state.tokenize = X), c(ht));
            }
            function Qe(f, m) {
              return (f == "variable" && F.stream.match(/^\s*[?:]/, !1)) || m == "?"
                ? c(Qe)
                : f == ":"
                  ? c(Re)
                  : f == "spread"
            ...
            function It(f, m) {
              ...
              if (m == "extends" || m == "implements") return ((F.marked = "keyword"), c(Re));
            ...
            function Er(f, m) {
              return m == "enum" ? ((F.marked = "keyword"), c(ye)) : G(kt, or, Rt, xi);
            }
            function kt(f, m) {
            ...
            function Or(f, m) {
              if (f == "keyword b" && m == "else") return c(le("form", "else"), Fe, xe);
            }
            function Rn(f, m) {
            ...
            function Wn(f, m) {
              if (f == "keyword" || f == "variable") return ((F.marked = "type"), c(Wn));
            ...
            function Ht(f, m) {
              ...
              if (m == "extends" || m == "implements" || (Y && f == ","))
                return (m == "implements" && (F.marked = "keyword"), c(Y ? Re : ve, Ht));
            ...
            function fr(f) {
              return f == "string" ? c() : f == "(" ? G(ve) : f == "." ? G(Pe) : G(Br, Gt, Rr);
            }
            function Br(f, m) {
              return f == "{"
                ? Mt(Br, "}")
                : (f == "variable" && C(m), m == "*" && (F.marked = "keyword"), c(sn));
            }
            function Gt(f) {
              if (f == ",") return c(Br, Gt);
            }
            ...
            return {
              startState: function (f) {
                ...
                return (
                  _.globalVars && typeof _.globalVars == "object" && (m.globalVars = _.globalVars),
                  m
                );
              },
              token: function (f, m) {
                if (
                  (f.sol() &&
                    (m.lexical.hasOwnProperty("align") || (m.lexical.align = !1),
                ...
                return ue == "comment"
                  ? U
                  : ((m.lastType = ue == "operator" && (O == "++" || O == "--") ? "incdec" : ue),
                    $(m, U, ue, O, f));
              },
              indent: function (f, m) {
                ...
                return it == "vardef"
                  ? re.indented +
                      (f.lastType == "operator" || f.lastType == "," ? re.info.length + 1 : 0)
                  : it == "form" && U == "{"
                    ? re.indented
                    : it == "form"
                      ? re.indented + te
                      : it == "stat"
                        ...
                        : re.info == "switch" && !wt && _.doubleIndentSwitch != !1
                          ? re.indented + (/^(?:case|default)\b/.test(m) ? te : 2 * te)
                          : re.align
                            ? re.column + (wt ? 0 : 1)
                            : re.indented + (wt ? 0 : te);
              },
    ...
    wa ||
      ...
      (function (ct, xt) {
        (function (b) {
          ...
          function _(ne, S, R) {
            ...
            return (
              V > -1
                ...
                : A.match(/<\/?$/) && (ne.backUp(A.length), ne.match(S, !1) || ne.match(A)),
              R
            );
          }
          var te = {};
          function oe(ne) {
            var S = te[ne];
            return S || (te[ne] = new RegExp("\\s+" + ne + `\\s*=\\s*('|")?([^'"]+)('|")?\\s*`));
          }
          function Q(ne, S) {
            var R = ne.match(oe(S));
          ...
          function I(ne, S) {
            for (var R in ne)
              for (var A = S[R] || (S[R] = []), V = ne[R], ue = V.length - 1; ue >= 0; ue--)
                A.unshift(V[ue]);
          }
          function Y(ne, S) {
              ...
              function w(M, N) {
                ...
                if (
                  ...
                  ((N.token = function (F, G) {
                    return F.match(P, !1)
                      ? ((G.token = w), (G.localState = G.localMode = null), null)
                      : _(F, $, G.localMode.token(F, G.localState));
                  }),
                    (N.localMode = J),
                    (N.localState = b.startState(J, R.indent(N.htmlState, "", ""))));
                } else N.inTag && ((N.inTag += M.current()), M.eol() && (N.inTag += " "));
                return z;
              }
              return {
                startState: function () {
                  var M = b.startState(R);
                  return { token: w, inTag: null, localMode: null, localState: null, htmlState: M };
                },
                copyState: function (M) {
                  var N;
                  return (
                    M.localState && (N = b.copyState(M.localMode, M.localState)),
                    {
                      token: M.token,
                      inTag: M.inTag,
                ...
                innerMode: function (M) {
                  return { state: M.localState || M.htmlState, mode: M.localMode || R };
                },
              };
            },
            "xml",
    ...
    La ||
      ...
      (function (ct, xt) {
        (function (b) {
          ...
          b.registerHelper("hintWords", "python", te.concat(oe).concat(["exec", "print"]));
          function Q(I) {
          ...
          (b.defineMode("python", function (I, Y) {
            ...
            if (w) {
              ...
              var N = new RegExp(`^(([rbuf]|(br)|(rb)|(fr)|(rf))?('{3}|"{3}|['"]))`, "i");
            } else {
              var M = Y.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
            ...
            function q(T, C) {
              ...
              if ((g && (C.indent = T.indentation()), g && Q(C).type == "py")) {
                ...
                if (T.eatSpace()) {
                  var j = T.indentation();
                  return (
                    j > y ? P(C) : j < y && F(T, C) && T.peek() != "#" && (C.errorToken = !0),
                    null
                  );
                } else {
                  var de = p(T, C);
            ...
            function p(T, C, g) {
              ...
              if (T.match(N)) {
                ...
                return de
                  ? ((C.tokenize = W(T.current(), C.tokenize)), C.tokenize(T, C))
                  : ((C.tokenize = J(T.current(), C.tokenize)), C.tokenize(T, C));
              }
              for (var v = 0; v < R.length; v++) if (T.match(R[v])) return "operator";
              return T.match(S)
                ? "punctuation"
                  ...
                  return (
                    Te == "punctuation" &&
                      (d.current() == "{"
                        ? (fe.tokenize = j(v + 1))
                        : d.current() == "}" &&
                          (v > 1 ? (fe.tokenize = j(v - 1)) : (fe.tokenize = de))),
                    Te
                  );
                };
              }
              function de(v, d) {
                for (; !v.eol(); )
                  if ((v.eatWhile(/[^'"\{\}\\]/), v.eat("\\"))) {
                    ...
                    if (v.match("{{")) return y;
                    if (v.match("{", !1))
                      return ((d.tokenize = j(0)), v.current() ? y : d.tokenize(v, d));
                    if (v.match("}}")) return y;
            ...
            function F(T, C) {
              for (var g = T.indentation(); C.scopes.length > 1 && Q(C).offset > g; ) {
            ...
            function G(T, C) {
              ...
              if (
                ...
                (g == "variable" || g == "builtin") && C.lastToken == "meta" && (g = "meta"),
                (y == "pass" || y == "return") && (C.dedent = !0),
                y == "lambda" && (C.lambda = !0),
                y == ":" && !C.lambda && Q(C).type == "py" && T.match(/^\s*(?:#|$)/, !1) && P(C),
                y.length == 1 && !/string|comment/.test(g))
              ) {
                var j = "[({".indexOf(y);
                if ((j != -1 && $(T, C, "])}".slice(j, j + 1)), (j = "])}".indexOf(y)), j != -1))
                  if (Q(C).type == y) C.indent = C.scopes.pop().offset - V;
                  else return ne;
              }
              return (
                C.dedent && T.eol() && Q(C).type == "py" && C.scopes.length > 1 && C.scopes.pop(),
                g
              );
            }
            var c = {
              ...
              token: function (T, C) {
                ...
                return (
                  y &&
                    y != "comment" &&
                    (C.lastToken = y == "keyword" || y == "punctuation" ? T.current() : y),
              ...
              indent: function (T, C) {
                ...
                return g.align != null ? g.align - (y ? 1 : 0) : g.offset - (y ? V : 0);
              },
      ...
      (function (ct, xt) {
        (function (b) {
          ...
          function te(g) {
            ...
            return (
              (y == ")" || y == "]" || y == "}") && (g.indented = g.context.indented),
          ...
          b.defineMode("clike", function (g, y) {
            ...
            function E(me, De) {
              ...
              if (be == '"' || be == "'") return ((De.tokenize = ee(be)), De.tokenize(me, De));
              if (dt.test(be)) {
              ...
              var Ne = me.current();
              return I(d, Ne)
                ? (I(le, Ne) && (we = "newstatement"), I(xe, Ne) && (Ie = !0), "keyword")
                : I(fe, Ne)
                  ? "type"
                  : I(Te, Ne) || (et && et(Ne))
            ...
            return {
              ...
              token: function (me, De) {
                ...
                if (
                  ...
                  for (be.type == "}" && (be = te(De)); be.type == "statement"; ) be = te(De);
                } else
                  we == be.type
                    ? te(De)
                    : ve &&
              ...
              indent: function (me, De) {
                ...
                var be = me.context,
                  Be = De && De.charAt(0),
                  Ne = Be == be.type;
                if ((be.type == "statement" && Be == "}" && (be = be.prev), y.dontIndentStatements))
                  for (; be.type == "statement" && y.dontIndentStatements.test(be.info); )
                    be = be.prev;
                if (Fe.indent) {
          ...
          function k(g) {
            for (var y = {}, j = g.split(" "), de = 0; de < j.length; ++de) y[j[de]] = !0;
            return y;
          }
          function I(g, y) {
          ...
          function p(g, y) {
            if ((g.backUp(1), g.match(/^(?:R|u8R|uR|UR|LR)/))) {
              ...
              return j ? ((y.cpp11RawStringDelim = j[1]), (y.tokenize = P), P(g, y)) : !1;
            }
          ...
          function $(g, y) {
            ...
            (de(y.keywords),
              ...
              de(y.builtin),
              de(y.atoms),
              j.length && ((y.helperType = g[0]), b.registerHelper("hintWords", g[0], j)));
            ...
            hooks: {
              ...
              "=": function (g, y) {
                ...
                return j.type == "}" && j.align && g.eat(">")
                  ? ((y.context = new pe(j.indented, j.column, j.type, j.info, null, j.prev)),
                    "operator")
                  : !1;
              },
              "/": function (g, y) {
          ...
          ($("text/x-kotlin", {
            ...
            number:
              /^(?:0x[a-f\d_]+|0b[01_]+|(?:[\d_]+(\.\d+)?|\.\d+)(?:e[-+]?[\d_]+)?)(u|ll?|l|f)?/i,
            blockKeywords: k("catch class do else finally for if where try while enum"),
            ...
            hooks: {
              ...
              indent: function (g, y, j, de) {
                var v = j && j.charAt(0);
                if ((g.prevToken == "}" || g.prevToken == ")") && j == "") return g.indented;
                if (
                  (g.prevToken == "operator" && j != "}" && g.context.type != "}") ||
                  (g.prevToken == "variable" && v == ".") ||
                  ((g.prevToken == "}" || g.prevToken == ")") && v == ".")
                )
                  return de * 2 + y.indented;
                if (y.align && y.type == "}")
                  return y.indented + (g.context.type == (j || "").charAt(0) ? 0 : de);
              },
            },
            ...
            $("text/x-objectivec", {
              ...
              builtin: k(R),
              blockKeywords: k(
                w + " @synthesize @try @catch @finally @autoreleasepool @synchronized"
              ),
              defKeywords: k(M + " @interface @implementation @protocol @class"),
            ...
            $("text/x-objectivec++", {
              ...
              defKeywords: k(M + " @interface @implementation @protocol @class class namespace"),
              dontIndentStatements: /^@.*$|^template$/,
              typeFirstDefinitions: !0,
              atoms: k("YES NO NULL Nil nil true false nullptr"),
              isReservedIdentifier: X,
            ...
            $("text/x-squirrel", {
              ...
              types: ue,
              blockKeywords: k("case catch class else for foreach if switch try while"),
          ...
          $("text/x-ceylon", {
            ...
            defKeywords: k("class dynamic function interface module object package value"),
            builtin: k(
        ...
        (function (b) {
          ...
          ((b.findModeByMIME = function (te) {
            ...
            for (var oe = 0; oe < b.modeInfo.length; oe++) {
              ...
              if (Q.mimes) {
                for (var k = 0; k < Q.mimes.length; k++) if (Q.mimes[k] == te) return Q;
              }
            }
            ...
            (b.findModeByExtension = function (te) {
              ...
              for (var oe = 0; oe < b.modeInfo.length; oe++) {
                var Q = b.modeInfo[oe];
                if (Q.ext) {
                  for (var k = 0; k < Q.ext.length; k++) if (Q.ext[k] == te) return Q;
                }
              }
            }),
        ...
        (function (b) {
          ...
          (b.defineMode(
            ...
            function (pe, _) {
              ...
              (_.highlightFormatting === void 0 && (_.highlightFormatting = !1),
                ...
                _.fencedCodeBlockHighlighting === void 0 && (_.fencedCodeBlockHighlighting = !0),
              ...
              for (var I in k)
                k.hasOwnProperty(I) && _.tokenTypeOverrides[I] && (k[I] = _.tokenTypeOverrides[I]);
              var Y = /^([*\-_])(?:\s*\1){2,}\s*$/,
                ne = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
                S = /^\[(x| )\](?=\s)/i,
              ...
              function p(v, d) {
                ...
                if (d.indentationDiff === null && ((d.indentationDiff = d.indentation), Me)) {
                  for (d.list = null; Ce < d.listStack[d.listStack.length - 1]; )
                    (d.listStack.pop(),
                      d.listStack.length
                        ? (d.indentation = d.listStack[d.listStack.length - 1])
                        : (d.list = !1));
                  d.list !== !1 && (d.indentationDiff = Ce - d.listStack[d.listStack.length - 1]);
                }
                var ve =
                    !Te && !xe && !d.prevLine.header && (!Me || !le) && !d.prevLine.fencedCodeEnd,
                  Oe = (d.list === !1 || xe || Te) && d.indentation <= Fe && v.match(Y),
                  qe = null;
                if (
                  d.indentationDiff >= 4 &&
                ...
                if (fe && d.indentation <= Fe && (qe = v.match(R)) && qe[1].length <= 6)
                  return (
                    (d.quote = 0),
                ...
                if (!Oe && !d.setext && fe && d.indentation <= Fe && (qe = v.match(ne))) {
                  var Ve = qe[1] ? "ol" : "ul";
                  return (
                    ...
                    (d.f = d.inline),
                    _.highlightFormatting && (d.formatting = ["list", "list-" + Ve]),
                    P(d)
                  );
                } else {
                  if (fe && d.indentation <= Fe && (qe = v.match(ue, !0)))
                    return (
                      ...
                      (d.localMode =
                        _.fencedCodeBlockHighlighting && Q(qe[2] || _.fencedCodeBlockDefaultMode)),
                    ...
                    return (
                      d.setext
                        ? ((d.header = d.setext),
                          ...
                          v.skipToEnd(),
                          _.highlightFormatting && (d.formatting = "header"))
                        : ((d.header = qe[0].charAt(0) == "=" ? 1 : 2), (d.setext = d.header)),
                      (d.thisLine.header = !0),
                      (d.f = d.inline),
                      P(d)
                    );
                  if (Oe) return (v.skipToEnd(), (d.hr = !0), (d.thisLine.hr = !0), k.hr);
              ...
              function J(v, d) {
                var fe = d.listStack[d.listStack.length - 1] || 0,
                  Te = d.indentation < fe,
                  le = fe + 3;
                if (d.fencedEndRE && d.indentation <= le && (Te || v.match(d.fencedEndRE))) {
                  _.highlightFormatting && (d.formatting = "code-block");
                  var xe;
                  return (
                    Te || (xe = P(d)),
                  ...
                  return d.localMode ? d.localMode.token(v, d.localState) : (v.skipToEnd(), k.code);
              }
              function P(v) {
                var d = [];
                if (v.formatting) {
                  (d.push(k.formatting),
                    typeof v.formatting == "string" && (v.formatting = [v.formatting]));
                  for (var fe = 0; fe < v.formatting.length; fe++)
                    (d.push(k.formatting + "-" + v.formatting[fe]),
                      v.formatting[fe] === "header" &&
                        d.push(k.formatting + "-" + v.formatting[fe] + "-" + v.header),
                      v.formatting[fe] === "quote" &&
                        (!_.maxBlockquoteDepth || _.maxBlockquoteDepth >= v.quote
                          ? d.push(k.formatting + "-" + v.formatting[fe] + "-" + v.quote)
                          : d.push("error")));
                }
                if (v.taskOpen) return (d.push("meta"), d.length ? d.join(" ") : null);
                if (v.taskClosed) return (d.push("property"), d.length ? d.join(" ") : null);
                if (
                  (v.linkHref
                  ...
                  Te ? (Te === 1 ? d.push(k.list2) : d.push(k.list3)) : d.push(k.list1);
                }
                return (
                  v.trailingSpaceNewLine
                    ? d.push("trailing-space-new-line")
                    : v.trailingSpace &&
                      d.push("trailing-space-" + (v.trailingSpace % 2 ? "a" : "b")),
              ...
              function F(v, d) {
                ...
                if (((d.taskOpen = !1), (d.taskClosed = !1), d.header && v.match(/^#+$/, !0)))
                  return (_.highlightFormatting && (d.formatting = "header"), P(d));
                var le = v.next();
                if (d.linkTitle) {
                  d.linkTitle = !1;
                  var xe = le;
                ...
                if (le === "`") {
                  var Fe = d.formatting;
                  (_.highlightFormatting && (d.formatting = "code"), v.eatWhile("`"));
                  var Ce = v.current().length;
                  if (d.code == 0 && (!d.quote || Ce == 1)) return ((d.code = Ce), P(d));
                  if (Ce == d.code) {
                    var ve = P(d);
                    return ((d.code = 0), ve);
                ...
                if (le === "]" && d.imageAltText) {
                  _.highlightFormatting && (d.formatting = "image");
                  var Oe = P(d);
                  return ((d.imageAltText = !1), (d.image = !1), (d.inline = d.f = c), Oe);
                }
                if (le === "[" && !d.image)
                  return (
                    (d.linkText && v.match(/^.*?\]/)) ||
                      ((d.linkText = !0), _.highlightFormatting && (d.formatting = "link")),
                    P(d)
                  );
                if (le === "]" && d.linkText) {
                ...
                if (le === "<" && v.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)) {
                  ((d.f = d.inline = G), _.highlightFormatting && (d.formatting = "link"));
                  var Oe = P(d);
                ...
                if (
                  ...
                  if (Ve != -1) {
                    ...
                    /markdown\s*=\s*('|"){0,1}1('|"){0,1}/.test(dt) && (d.md_inside = !0);
                  }
                  return (v.backUp(1), (d.htmlState = b.startState(te)), z(v, d, W));
                }
                if (_.xml && le === "<" && v.match(/^\/\w*?>/)) return ((d.md_inside = !1), "tag");
                if (le === "*" || le === "_") {
                  for (
                    var Pe = 1, _e = v.pos == 1 ? " " : v.string.charAt(v.pos - 2);
                    Pe < 3 && v.eat(le);
                  )
                    Pe++;
                  var Ue = v.peek() || " ",
                    et = !/\s/.test(Ue) && (!w.test(Ue) || /\s/.test(_e) || w.test(_e)),
                    we = !/\s/.test(_e) && (!w.test(_e) || /\s/.test(Ue) || w.test(Ue)),
                    Ie = null,
                    E = null;
                  if (
                    (Pe % 2 &&
                      (!d.em && et && (le === "*" || !we || w.test(_e))
                        ? (Ie = !0)
                        : d.em == le && we && (le === "*" || !et || w.test(Ue)) && (Ie = !1)),
                    Pe > 1 &&
                      (!d.strong && et && (le === "*" || !we || w.test(_e))
                        ? (E = !0)
                        : d.strong == le && we && (le === "*" || !et || w.test(Ue)) && (E = !1)),
                    E != null || Ie != null)
                  ) {
                    (_.highlightFormatting &&
                      (d.formatting = Ie == null ? "strong" : E == null ? "em" : "strong em"),
                      Ie === !0 && (d.em = le),
                      E === !0 && (d.strong = le));
                    var ve = P(d);
                    return (Ie === !1 && (d.em = !1), E === !1 && (d.strong = !1), ve);
                  }
              ...
              function G(v, d) {
                var fe = v.next();
                if (fe === ">") {
                  ((d.f = d.inline = F), _.highlightFormatting && (d.formatting = "link"));
                  var Te = P(d);
              ...
              function y(v, d) {
                if (v.match("]:", !0)) {
                  ((d.f = d.inline = j), _.highlightFormatting && (d.formatting = "link"));
                  var fe = P(d);
              ...
              var de = {
                ...
                copyState: function (v) {
                  return {
                    ...
                    localState: v.localMode ? b.copyState(v.localMode, v.localState) : null,
                    inline: v.inline,
                    text: v.text,
                    formatting: !1,
                    linkText: v.linkText,
                ...
                token: function (v, d) {
                  if (((d.formatting = !1), v != d.thisLine.stream)) {
                    if (((d.header = 0), (d.hr = !1), v.match(/^\s*$/, !0))) return (q(d), null);
                    if (
                      ...
                      if (((d.indentation = fe), (d.indentationDiff = null), fe > 0)) return null;
                    }
                  }
                  return d.f(v, d);
                },
        ...
        (function (b) {
          ...
          b.defineOption("placeholder", "", function (I, Y, ne) {
            ...
            if (Y && !S)
              ...
              (I.off("blur", oe),
                I.off("change", Q),
                I.off("swapDoc", Q),
                b.off(I.getInputField(), "compositionupdate", I.state.placeholderCompose),
                pe(I));
          ...
          function _(I) {
            ...
            (typeof ne == "string" && (ne = document.createTextNode(ne)),
              Y.appendChild(ne),
              I.display.lineSpace.insertBefore(Y, I.display.lineSpace.firstChild));
          }
          function te(I) {
            setTimeout(function () {
              var Y = !1;
              if (I.lineCount() == 1) {
                ...
                Y =
                  ne.nodeName == "TEXTAREA"
                    ? !I.getLine(0).length
                    : !/[^\u200b]/.test(ne.querySelector(".CodeMirror-line").textContent);
              }
              Y ? _(I) : pe(I);
            }, 20);
          }
          ...
          function Q(I) {
            var Y = I.getWrapperElement(),
              ne = k(I);
            ((Y.className =
              Y.className.replace(" CodeMirror-empty", "") + (ne ? " CodeMirror-empty" : "")),
              ne ? _(I) : pe(I));
          }
          function k(I) {
    ...
    Pa ||
      ...
      (function (ct, xt) {
        (function (b) {
            ...
            (b.simpleMode = function (S, R) {
              ...
              for (var O in R)
                if (O != V && R.hasOwnProperty(O))
                  for (var w = (A[O] = []), M = R[O], N = 0; N < M.length; N++) {
                    var z = M[N];
              ...
              var X = {
                ...
                copyState: function (p) {
                  ...
                  (p.localState && (W.localState = b.copyState(p.local.mode, p.localState)),
                    p.stack && (W.stack = p.stack.slice(0)));
                  for (var J = p.persistentStates; J; J = J.next)
                    W.persistentStates = {
                      mode: J.mode,
                      spec: J.spec,
                      state: J.state == p.localState ? W.localState : b.copyState(J.mode, J.state),
          ...
          function pe(S, R) {
            if (!S.hasOwnProperty(R)) throw new Error("Undefined state " + R + " in simple mode");
          }
          function _(S, R) {
            if (!S) return /(?:)/;
            var A = "";
            return (
              S instanceof RegExp
                ? (S.ignoreCase && (A = "i"), S.unicode && (A += "u"), (S = S.source))
                : (S = String(S)),
              new RegExp((R === !1 ? "" : "^") + "(?:" + S + ")", A)
            );
          }
          function te(S) {
            ...
            for (var R = [], A = 0; A < S.length; A++) R.push(S[A] && S[A].replace(/\./g, " "));
            return R;
          }
          function oe(S, R) {
              ...
              for (var M = S[V.state], N = 0; N < M.length; N++) {
                ...
                if (X) {
                  (z.data.next
                    ? (V.state = z.data.next)
                    : z.data.push
                      ? ((V.stack || (V.stack = [])).push(V.state), (V.state = z.data.push))
                      : z.data.pop && V.stack && V.stack.length && (V.state = V.stack.pop()),
                    z.data.mode && I(R, V, z.data.mode, z.token),
                    z.data.indent && V.indent.push(A.indentation() + R.indentUnit),
                  ...
                  if (
                    ...
                    for (var p = 2; p < X.length; p++)
                      X[p] &&
                        (V.pending || (V.pending = [])).push({ text: X[p], token: z.token[p - 1] });
                    return (A.backUp(X[0].length - (X[1] ? X[1].length : 0)), q[0]);
          ...
          function k(S, R) {
            if (S === R) return !0;
            if (!S || typeof S != "object" || !R || typeof R != "object") return !1;
            var A = 0;
            for (var V in S)
          ...
          function I(S, R, A, V) {
            ...
            (A.persistent &&
              !ue &&
              (R.persistentStates = { mode: w, spec: A.spec, state: M, next: R.persistentStates }),
              (R.localState = M),
              (R.local = {
                mode: w,
                end: A.end && _(A.end),
          ...
          function ne(S, R) {
            return function (A, V, ue) {
              if (A.local && A.local.mode.indent) return A.local.mode.indent(A.localState, V, ue);
              if (
                A.indent == null ||
                A.local ||
        ...
        (function (b) {
          ...
          function Q(S, R, A) {
            var V = S.getLineHandle(R.line),
              ue = R.ch - 1,
              O = A && A.afterCursor;
            O == null && (O = /(^| )cm-fat-cursor($| )/.test(S.getWrapperElement().className));
            var w = oe(A),
              M =
                (!O && ue >= 0 && w.test(V.text.charAt(ue)) && te[V.text.charAt(ue)]) ||
            ...
            for (
              ...
              if (q) {
                var p = A > 0 ? 0 : q.length - 1,
                  W = A > 0 ? q.length : -1;
                if (!(q.length > O))
                  for (X == R.line && (p = R.ch - (A < 0 ? 1 : 0)); p != W; p += A) {
                    var J = q.charAt(p);
                    if (
                      N.test(J) &&
                      (V === void 0 || (S.getTokenTypeAt(_(X, p + 1)) || "") == (V || ""))
                    ) {
                      var P = te[J];
          ...
          function I(S, R, A) {
            for (
              ...
              if (N && (N.match || ue !== !1) && S.getLine(N.from.line).length <= V) {
                var z = N.match ? "CodeMirror-matchingbracket" : "CodeMirror-nonmatchingbracket";
                (O.push(S.markText(N.from, _(N.from.line, N.from.ch + 1), { className: z })),
                  N.to &&
                    S.getLine(N.to.line).length <= V &&
                    O.push(S.markText(N.to, _(N.to.line, N.to.ch + 1), { className: z })));
              }
            }
            if (O.length) {
          ...
          function Y(S) {
            S.operation(function () {
              (S.state.matchBrackets.currentlyHighlighted &&
                ...
                (S.state.matchBrackets.currentlyHighlighted = I(S, !1, S.state.matchBrackets)));
            });
          }
          function ne(S) {
          ...
          (b.defineOption("matchBrackets", !1, function (S, R, A) {
            (A &&
              A != b.Init &&
              (S.off("cursorActivity", Y), S.off("focus", Y), S.off("blur", ne), ne(S)),
              R &&
            ...
            b.defineExtension("findMatchingBracket", function (S, R, A) {
              return (
                (A || typeof R == "boolean") &&
                  (A ? ((A.strict = R), (R = A)) : (R = R ? { strict: !0 } : null)),
                Q(this, S, R)
              );
            }),
    ...
    Ra ||
      ...
      (function (ct, xt) {
        (function (b) {
          ...
          var pe = { pairs: `()[]{}''""`, closeBefore: `)]}'":;>`, triples: "", explode: "[]{}" },
            _ = b.Pos;
          b.defineOption("autoCloseBrackets", !1, function (O, w, M) {
            (M && M != b.Init && (O.removeKeyMap(oe), (O.state.closeBrackets = null)),
              w && (Q(te(w, "pairs")), (O.state.closeBrackets = w), O.addKeyMap(oe)));
          });
          function te(O, w) {
          ...
          function Y(O) {
            ...
            for (var M = te(w, "pairs"), N = O.listSelections(), z = 0; z < N.length; z++) {
            ...
            for (var z = N.length - 1; z >= 0; z--) {
              var q = N[z].head;
              O.replaceRange("", _(q.line, q.ch - 1), _(q.line, q.ch + 1), "+delete");
            }
          }
          function ne(O) {
            var w = I(O),
            ...
            O.operation(function () {
              var q =
                ...
                `
`;
              (O.replaceSelection(q + q, null), S(O, -1), (N = O.listSelections()));
          ...
          function S(O, w) {
            for (var M = [], N = O.listSelections(), z = 0, X = 0; X < N.length; X++) {
              var q = N[X];
          ...
          function A(O, w) {
            ...
            for (
              ...
              if (J && !F.empty()) c = "surround";
                ...
                p && ue(O, G)
                  ? (c = "both")
                  : q.indexOf(w) >= 0 && O.getRange(G, _(G.line, G.ch + 3)) == w + w + w
                    ? (c = "skipThree")
                    : (c = "skip");
              else if (
                p &&
                ...
                if (G.ch > 2 && /\bstring/.test(O.getTokenTypeAt(_(G.line, G.ch - 2))))
                  return b.Pass;
                c = "addFour";
              } else if (p) {
              ...
              } else if (J && (T.length === 0 || /\s/.test(T) || X.indexOf(T) > -1)) c = "both";
              else return b.Pass;
              if (!P) P = c;
            ...
            O.operation(function () {
              if (P == "skip") S(O, 1);
                ...
                for (var j = O.getSelections(), de = 0; de < j.length; de++) j[de] = g + j[de] + y;
                (O.replaceSelections(j, "around"), (j = O.listSelections().slice()));
                for (var de = 0; de < j.length; de++) j[de] = R(j[de]);
                O.setSelections(j);
              } else
                P == "both"
                  ? (O.replaceSelection(g + y, null), O.triggerElectric(g + y), S(O, -1))
                  : P == "addFour" && (O.replaceSelection(g + g + g + g, "before"), S(O, 1));
            });
          }
          function V(O, w) {
      ...
      (function (ct, xt) {
        (function (b) {
          ...
          function _(w) {
            var M = w.flags;
            return (
              M ?? (w.ignoreCase ? "i" : "") + (w.global ? "g" : "") + (w.multiline ? "m" : "")
            );
          }
          function te(w, M) {
          ...
          function Q(w, M, N) {
            M = te(M, "g");
            for (var z = N.line, X = N.ch, q = w.lastLine(); z <= q; z++, X = 0) {
              M.lastIndex = X;
              var p = w.getLine(z),
                W = M.exec(p);
              if (W) return { from: pe(z, W.index), to: pe(z, W.index + W[0].length), match: W };
            }
          }
          function k(w, M, N) {
...
`),
          ...
          function Y(w, M, N) {
            M = te(M, "g");
            for (var z = N.line, X = N.ch, q = w.firstLine(); z >= q; z--, X = -1) {
              var p = w.getLine(z),
          ...
          function ne(w, M, N) {
            ...
            M = te(M, "gm");
            for (
              var z, X = 1, q = w.getLine(N.line).length - N.ch, p = N.line, W = w.firstLine();
              p >= W;
            ) {
...
`),
          ...
          function V(w, M, N, z) {
            ...
            var X = z ? S : R,
              q = X(M).split(/\r|\n\r?/);
            e: for (var p = N.line, W = N.ch, J = w.lastLine() + 1 - q.length; p <= J; p++, W = 0) {
              ...
              if (q.length == 1) {
                ...
                for (var c = 1; c < q.length - 1; c++) if (X(w.getLine(p + c)) != q[c]) continue e;
          ...
          function ue(w, M, N, z) {
            ...
            e: for (
              ...
              if (q.length == 1) {
                ...
                if (F == -1) continue e;
                return { from: pe(p, A(P, $, F, X)), to: pe(p, A(P, $, F + q[0].length, X)) };
              } else {
                var G = q[q.length - 1];
                ...
                return {
                  from: pe(p + 1 - q.length, A(T, C, T.length - q[0].length, X)),
          ...
          ((O.prototype = {
            ...
            find: function (w) {
              ...
              if (
                ...
                w
                  ? (M.ch--,
                    M.ch < 0 && (M.line--, (M.ch = (this.doc.getLine(M.line) || "").length)))
                  : (M.ch++,
                    M.ch > (this.doc.getLine(M.line) || "").length && ((M.ch = 0), M.line++)),
                b.cmpPos(M, this.doc.clipPos(M)) != 0)
              )
                return (this.atOccurrence = !1);
              var N = this.matches(w, M);
              if (((this.afterEmptyMatch = N && b.cmpPos(N.from, N.to) == 0), N))
            ...
            b.defineExtension("selectMatches", function (w, M) {
              for (
                var N = [], z = this.getSearchCursor(w, this.getCursor("from"), M);
    ...
    ja ||
      ...
      (function (ct, xt) {
        (function (b) {
          ...
          function _(te, oe) {
            (te.state.currentNotificationClose && te.state.currentNotificationClose(),
          ...
          (b.defineExtension("openDialog", function (te, oe, Q) {
            ...
            return (
              S
                ? (S.focus(),
                  Q.value && ((S.value = Q.value), Q.selectValueOnOpen !== !1 && S.select()),
                  Q.onInput &&
                  ...
                  b.on(S, "keydown", function (A) {
                    (Q && Q.onKeyDown && Q.onKeyDown(A, S.value, ne)) ||
                      ((A.keyCode == 27 || (Q.closeOnEnter !== !1 && A.keyCode == 13)) &&
            ...
            return (
                ...
                : p.global || (p = new RegExp(p.source, p.ignoreCase ? "gi" : "g")),
              {
                token: function (J) {
                  ...
                  if (P && P.index == J.pos) return ((J.pos += P[0].length || 1), "searching");
...
`
          ...
          function S(p) {
            ...
            return ((typeof p == "string" ? p == "" : p.test("")) && (p = /x^/), p);
          }
          function R(p, W, J) {
            ((W.queryText = J),
              (W.query = S(J)),
          ...
          function A(p, W, J, P) {
            ...
            if ((F instanceof RegExp && F.source == "x^" && (F = null), J && p.openDialog)) {
              var G = null,
                c = function (T, C) {
                  (b.e_stop(C),
                    T &&
                      (T != $.queryText && (R(p, $, T), ($.posFrom = $.posTo = p.getCursor())),
                      G && (G.style.opacity = 1),
                      V(p, C.shiftKey, function (g, y) {
                        var j;
                        y.line < 3 &&
                          document.querySelector &&
                          (j = p.display.wrapper.querySelector(".CodeMirror-dialog")) &&
                          j.getBoundingClientRect().bottom - 4 > p.cursorCoords(y, "window").top &&
              ...
              (k(p, w(p), F, c, function (T, C) {
                ...
                j == "findPersistentPrev"
                  ...
                  : (j == "find" || j == "findPersistent") && (b.e_stop(T), c(C, T));
              }),
                P && F && (R(p, $, F), V(p, W)));
            } else
              I(p, w(p), "Search for:", F, function (T) {
                T &&
                  ...
                  p.operation(function () {
                    (R(p, $, T), ($.posFrom = $.posTo = p.getCursor()), V(p, W));
                  });
              });
          }
          function V(p, W, J) {
            p.operation(function () {
              ...
              (!$.find(W) &&
                (($ = Q(p, P.query, W ? b.Pos(p.lastLine()) : b.Pos(p.firstLine(), 0))),
                !$.find(W))) ||
          ...
          function O(p, W) {
            var J = p ? document.createElement(p) : document.createDocumentFragment();
            for (var P in W) J[P] = W[P];
            for (var $ = 2; $ < arguments.length; $++) {
              var F = arguments[$];
              J.appendChild(typeof F == "string" ? document.createTextNode(F) : F);
            }
            return J;
          }
          function w(p) {
          ...
          function N(p) {
            return O(
              "",
              null,
              O("span", { className: "CodeMirror-search-label" }, p.phrase("With:")),
              " ",
              O("input", {
                type: "text",
                style: "width: 10em",
          ...
          function z(p) {
            return O(
              "",
              null,
              O("span", { className: "CodeMirror-search-label" }, p.phrase("Replace?")),
              " ",
          ...
          function q(p, W) {
            if (!p.getOption("readOnly")) {
              var J = p.getSelection() || te(p).lastQuery,
                ...
                $ = O("", null, O("span", { className: "CodeMirror-search-label" }, P), M(p));
              I(p, $, P, J, function (F) {
                F &&
                  ((F = S(F)),
                      ...
                      var c = Q(p, F, p.getCursor("from")),
                        T = function () {
                          ...
                          (!(y = c.findNext()) &&
                            ((c = Q(p, F)),
                            !(y = c.findNext()) ||
                              (g && c.from().line == g.line && c.from().ch == g.ch))) ||

...
| **22** | fix(auth): v2_ membership reads, collection prefix, targetTenantId | `fix/p0-auth-membership-v2` | https://github.com/subhangR/lvlup-monorepo/pull/22 |
| **23** | changes *(upstream staging → main, author subhangR)* | `staging` | https://github.com/subhangR/lvlup-monorepo/pull/23 |
...
- **Client impact if unmerged:** Upstream `main` lacks these fixes; demos should use fork tip / topic branches

...
description:
  Apply brand colors and typography to artifacts. Use when brand colors, style
  guidelines, visual formatting, or company design standards apply. Ensures
...
Apply consistent brand styling to any artifact: documents, presentations, web

...
See **[docs/CI-GREEN-PRS.md](../../docs/CI-GREEN-PRS.md)** for the 100-PR campaign checklist:

- Do not commit `functions/*/lib` rebuild noise, `tmp/`, `test-results/`, or service-account JSON.
- Run lint + typecheck + build before opening a PR.
- **Fork PRs:** if Actions stay on “Awaiting approval”, a maintainer must **Approve and run workflows** once for that fork/PR.

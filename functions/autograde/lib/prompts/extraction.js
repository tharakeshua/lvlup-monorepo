...
exports.EXTRACTION_USER_PROMPT = exports.EXTRACTION_SYSTEM_PROMPT = void 0;
exports.parseExtractionResponse = parseExtractionResponse;
exports.EXTRACTION_SYSTEM_PROMPT = `You are an expert exam question extractor. Your job is to analyze question paper images and extract every question with precise accuracy.
...
exports.EXTRACTION_USER_PROMPT = `Analyze the attached question paper image(s) and extract all questions.
